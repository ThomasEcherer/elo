-- pg_00_sol.common.sql created at 2017-11-21 13:27:16

DROP TABLE IF EXISTS sol_accounting_costcenter;
CREATE TABLE sol_accounting_costcenter (company_code CHARACTER VARYING(20) NOT NULL, no CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(100) NOT NULL, PRIMARY KEY (company_code, no));

DROP TABLE IF EXISTS sol_accounting_costobject;
CREATE TABLE sol_accounting_costobject (company_code CHARACTER VARYING(20) NOT NULL, no CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(100) NOT NULL, PRIMARY KEY (company_code, no));

DROP TABLE IF EXISTS sol_accounting_gl_account;
CREATE TABLE sol_accounting_gl_account (company_code CHARACTER VARYING(20) NOT NULL, no CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(100) NOT NULL, PRIMARY KEY (company_code, no));

DROP TABLE IF EXISTS sol_business_area;
CREATE TABLE sol_business_area (company_code CHARACTER VARYING(20) NOT NULL, code CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(100) NOT NULL, PRIMARY KEY (company_code, code));

DROP TABLE IF EXISTS sol_common_fx;
CREATE TABLE sol_common_fx (currency_code CHARACTER VARYING(20) NOT NULL, currency_exchange_rate CHARACTER VARYING(10) NOT NULL, currency_symbol CHARACTER VARYING(10) NULL, currency_description CHARACTER VARYING(50) NULL, time CHARACTER VARYING(14) NOT NULL, PRIMARY KEY (currency_code));

DROP TABLE IF EXISTS sol_company;
CREATE TABLE sol_company (code CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(150) NULL, street CHARACTER VARYING(150) NULL, zipcode CHARACTER VARYING(20) NULL, city CHARACTER VARYING(50) NULL, country_code CHARACTER VARYING(50) NULL, gln CHARACTER VARYING(15) NULL, standard_currency_code CHARACTER VARYING(10) NULL, PRIMARY KEY (code));

DROP TABLE IF EXISTS sol_inbox_register;
CREATE TABLE sol_inbox_register (pos CHARACTER VARYING(50) NOT NULL, main_register CHARACTER VARYING(50) NULL, register CHARACTER VARYING(50) NULL, doctype_name CHARACTER VARYING(100) NULL, doctype_id CHARACTER VARYING(10) NULL, workflow CHARACTER VARYING(50) NULL, PRIMARY KEY (pos));

DROP TABLE IF EXISTS sol_internal_order;
CREATE TABLE sol_internal_order (company_code CHARACTER VARYING(20) NOT NULL, no CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(100) NOT NULL, PRIMARY KEY (company_code, no));

DROP TABLE IF EXISTS sol_invoice_item;
CREATE TABLE sol_invoice_item (company_code CHARACTER VARYING(20) NOT NULL, no CHARACTER VARYING(20) NOT NULL, description CHARACTER VARYING(150) NOT NULL, unit_name CHARACTER VARYING(50) NULL, unit_price NUMERIC(18,4) NULL, cost_center_no CHARACTER VARYING(50) NULL, cost_object_no CHARACTER VARYING(50) NULL, gl_account_no CHARACTER VARYING(50) NULL, vendor_no CHARACTER VARYING(50) NULL, PRIMARY KEY (company_code, no));

DROP TABLE IF EXISTS sol_invoice_po_line;
...
DROP TABLE IF EXISTS sol_profit_center;
CREATE TABLE sol_profit_center (company_code CHARACTER VARYING(20) NOT NULL, code CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(100) NOT NULL, PRIMARY KEY (company_code, code));

DROP TABLE IF EXISTS sol_project;
CREATE TABLE sol_project (company_code CHARACTER VARYING(20) NOT NULL, no CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(100) NULL, PRIMARY KEY (company_code, no));

DROP TABLE IF EXISTS sol_special_gl_indicator;
CREATE TABLE sol_special_gl_indicator (company_code CHARACTER VARYING(20) NOT NULL, code CHARACTER VARYING(10) NOT NULL, language CHARACTER VARYING(10) NOT NULL, description CHARACTER VARYING(100) NULL, PRIMARY KEY (company_code, code, language));

DROP TABLE IF EXISTS sol_tax_code;
CREATE TABLE sol_tax_code (company_code CHARACTER VARYING(20) NOT NULL, code CHARACTER VARYING(10) NOT NULL, language CHARACTER VARYING(10) NOT NULL, description CHARACTER VARYING(100) NULL, vat_rate NUMERIC(18,4) NOT NULL, PRIMARY KEY (company_code, code, language));

DROP TABLE IF EXISTS sol_trade_charge;
CREATE TABLE sol_trade_charge (code CHARACTER VARYING(10) NOT NULL, language CHARACTER VARYING(10) NOT NULL, description CHARACTER VARYING(100) NULL, docxfield CHARACTER VARYING(50) NULL, PRIMARY KEY (code, language));

DROP TABLE IF EXISTS sol_units;
CREATE TABLE sol_units (code CHARACTER VARYING(10) NOT NULL, language CHARACTER VARYING(10) NOT NULL, description CHARACTER VARYING(100) NULL, symbol CHARACTER VARYING(20) NULL, PRIMARY KEY (code, language));

DROP TABLE IF EXISTS sol_vat_rates;
CREATE TABLE sol_vat_rates (country CHARACTER VARYING(20) NOT NULL, start_date DATE NOT NULL, vat_rates CHARACTER VARYING(100) NOT NULL, PRIMARY KEY (country, start_date, vat_rates));

DROP TABLE IF EXISTS sol_vendor;
CREATE TABLE sol_vendor (company_code CHARACTER VARYING(20) NOT NULL, no CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(100) NULL, street CHARACTER VARYING(150) NULL, zipcode CHARACTER VARYING(10) NULL, city CHARACTER VARYING(50) NULL, iban CHARACTER VARYING(100) NULL, bic CHARACTER VARYING(20) NULL, country_code CHARACTER VARYING(10) NULL, vat_id CHARACTER VARYING(30) NULL, due_days INTEGER NULL, tax_no CHARACTER VARYING(30) NULL, gln CHARACTER VARYING(15) NULL, PRIMARY KEY (company_code, no));

DROP TABLE IF EXISTS sol_vendor_terms_of_payment;
CREATE TABLE sol_vendor_terms_of_payment (company_code CHARACTER VARYING(20) NOT NULL, vendor_no CHARACTER VARYING(10) NOT NULL, cash_discount_days INTEGER NOT NULL, cash_discount_rate NUMERIC(18,4) NOT NULL, PRIMARY KEY (company_code, vendor_no, cash_discount_days));

DROP TABLE IF EXISTS sol_wbs_element;
CREATE TABLE sol_wbs_element (company_code CHARACTER VARYING(20) NOT NULL, code CHARACTER VARYING(20) NOT NULL, name CHARACTER VARYING(100) NOT NULL, PRIMARY KEY (company_code, code));
