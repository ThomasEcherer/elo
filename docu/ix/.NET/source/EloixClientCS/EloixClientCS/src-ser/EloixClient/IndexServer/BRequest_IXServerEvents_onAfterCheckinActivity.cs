...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServerEvents_onAfterCheckinActivity : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.onAfterCheckinActivity(ecValue, actValue, isNewValue, sordValue, sordZValue, unlockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1027171864L;		
	} // end class
}  // end namespace
