...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServerEvents_onAfterCheckinMap : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.onAfterCheckinMap(ecValue, domainNameValue, idValue, objIdValue, dataValue, unlockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1002917709L;		
	} // end class
}  // end namespace
