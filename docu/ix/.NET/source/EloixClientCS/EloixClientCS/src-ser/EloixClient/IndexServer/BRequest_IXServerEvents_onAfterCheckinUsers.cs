...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServerEvents_onAfterCheckinUsers : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.onAfterCheckinUsers(ecValue, userInfosValue, checkinUsersZValue, unlockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1723326561L;		
	} // end class
}  // end namespace
