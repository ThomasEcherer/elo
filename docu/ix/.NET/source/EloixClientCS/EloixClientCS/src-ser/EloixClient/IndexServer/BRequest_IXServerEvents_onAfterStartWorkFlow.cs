...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServerEvents_onAfterStartWorkFlow : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.onAfterStartWorkFlow(ecValue, workflowValue, sordValue, sordZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 527527197L;		
	} // end class
}  // end namespace
