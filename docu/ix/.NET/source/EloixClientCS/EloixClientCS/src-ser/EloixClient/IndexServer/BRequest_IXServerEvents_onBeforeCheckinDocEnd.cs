...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServerEvents_onBeforeCheckinDocEnd : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.onBeforeCheckinDocEnd(ecValue, sordValue, sordDBValue, parentSordValue, docValue, sordZValue, unlockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal EloixClient.IndexServer.Document docValue;
		...
		public static readonly long serialVersionUID = 129508967L;		
	} // end class
}  // end namespace
