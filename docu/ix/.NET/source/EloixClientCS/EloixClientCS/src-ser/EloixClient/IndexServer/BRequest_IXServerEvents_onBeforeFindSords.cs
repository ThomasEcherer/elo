...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServerEvents_onBeforeFindSords : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.onBeforeFindSords(ecValue, findInfoValue, sordZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 384369013L;		
	} // end class
}  // end namespace
