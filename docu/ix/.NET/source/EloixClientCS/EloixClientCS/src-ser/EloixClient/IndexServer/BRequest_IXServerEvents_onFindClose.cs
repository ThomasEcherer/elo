...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServerEvents_onFindClose : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.onFindClose(ecValue, findInfoValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal Object findInfoValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 1223837305L;		
	} // end class
}  // end namespace
