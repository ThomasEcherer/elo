...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServerEvents_onFindSordsResult : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.onFindSordsResult(ecValue, findInfoValue, sordZValue, findResultValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal EloixClient.IndexServer.FindResult findResultValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 127227249L;		
	} // end class
}  // end namespace
