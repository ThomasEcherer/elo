...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServerEvents_onReadSord : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.onReadSord(ecValue, sordValue, sordZValue, docValue, lockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 227337860L;		
	} // end class
}  // end namespace
