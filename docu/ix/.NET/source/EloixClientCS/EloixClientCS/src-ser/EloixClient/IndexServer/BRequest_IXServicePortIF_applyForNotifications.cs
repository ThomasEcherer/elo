...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_applyForNotifications : BMethodRequest, BSerializable
	{
		...
		internal EloixClient.IndexServer.ApplyForNotificationsInfo infoValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 1849289399L;		
	} // end class
}  // end namespace
