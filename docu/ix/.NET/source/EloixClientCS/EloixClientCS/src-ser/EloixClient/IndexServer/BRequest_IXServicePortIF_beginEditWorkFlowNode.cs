...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_beginEditWorkFlowNode : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.beginEditWorkFlowNode(ciValue, nFlowIdValue, nNodeIdValue, lockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 626823938L;		
	} // end class
}  // end namespace
