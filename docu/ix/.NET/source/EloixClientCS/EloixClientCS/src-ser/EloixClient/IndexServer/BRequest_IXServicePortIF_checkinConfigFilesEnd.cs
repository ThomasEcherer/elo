...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_checkinConfigFilesEnd : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.checkinConfigFilesEnd(ciValue, configFilesValue, unlockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal EloixClient.IndexServer.ConfigFile[] configFilesValue;
		...
		public static readonly long serialVersionUID = 1770305117L;		
	} // end class
}  // end namespace
