...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_checkinDocMask : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.checkinDocMask(ciValue, docMaskValue, docMaskZValue, unlockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal EloixClient.IndexServer.DocMask docMaskValue;
		...
		public static readonly long serialVersionUID = 1795441139L;		
	} // end class
}  // end namespace
