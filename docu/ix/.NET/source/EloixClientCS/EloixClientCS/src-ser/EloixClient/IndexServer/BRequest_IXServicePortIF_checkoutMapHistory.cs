...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_checkoutMapHistory : BMethodRequest, BSerializable
	{
		...
		internal String mapIdValue;

		internal EloixClient.IndexServer.MapHistZ membersZValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 739067188L;		
	} // end class
}  // end namespace
