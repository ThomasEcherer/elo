...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_checkoutOrgUnits : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.checkoutOrgUnits(ciValue, reservedValue, lockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal EloixClient.IndexServer.CheckoutOrgUnitInfo reservedValue;
		...
		public static readonly long serialVersionUID = 2042492025L;		
	} // end class
}  // end namespace
