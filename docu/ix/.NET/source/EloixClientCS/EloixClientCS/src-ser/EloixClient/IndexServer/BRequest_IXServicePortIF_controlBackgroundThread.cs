...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_controlBackgroundThread : BMethodRequest, BSerializable
	{
		...
		internal EloixClient.IndexServer.JobState jobStateValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 796672607L;		
	} // end class
}  // end namespace
