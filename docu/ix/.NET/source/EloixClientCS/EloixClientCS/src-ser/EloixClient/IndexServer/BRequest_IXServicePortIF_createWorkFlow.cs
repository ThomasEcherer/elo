...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_createWorkFlow : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.createWorkFlow(ciValue, wfNameValue, typeZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1798241359L;		
	} // end class
}  // end namespace
