...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_deleteMap : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.deleteMap(ciValue, domainNameValue, idValue, keyNamesValue, unlockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1691419845L;		
	} // end class
}  // end namespace
