...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_deleteWorkflowTemplate : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.deleteWorkflowTemplate(ciValue, flowIdValue, versionIdValue, unlockZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1634712102L;		
	} // end class
}  // end namespace
