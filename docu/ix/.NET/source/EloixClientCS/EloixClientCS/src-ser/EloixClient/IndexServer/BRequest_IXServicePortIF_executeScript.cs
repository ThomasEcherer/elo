...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_executeScript : BMethodRequest, BSerializable
	{
		...
		internal EloixClient.IndexServer.ExecuteScriptParams paramsValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 905800490L;		
	} // end class
}  // end namespace
