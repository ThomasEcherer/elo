...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_findFirstConfigFiles : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.findFirstConfigFiles(ciValue, findInfoValue, maxValue, configFileZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal EloixClient.IndexServer.FindConfigFileInfo findInfoValue;
		...
		public static readonly long serialVersionUID = 954269076L;		
	} // end class
}  // end namespace
