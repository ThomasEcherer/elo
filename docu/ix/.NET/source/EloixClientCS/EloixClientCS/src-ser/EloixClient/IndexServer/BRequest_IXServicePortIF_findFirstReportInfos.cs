...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_findFirstReportInfos : BMethodRequest, BSerializable
	{
		...
		internal EloixClient.IndexServer.FindReportInfo optsValue;
		...
		public static readonly long serialVersionUID = 693111280L;		
	} // end class
}  // end namespace
