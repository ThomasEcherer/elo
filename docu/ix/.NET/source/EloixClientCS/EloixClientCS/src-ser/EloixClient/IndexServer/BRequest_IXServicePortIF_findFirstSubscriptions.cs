...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_findFirstSubscriptions : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.findFirstSubscriptions(ciValue, findInfoValue, maxValue, subsZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal EloixClient.IndexServer.FindSubscriptionInfo findInfoValue;
		...
		public static readonly long serialVersionUID = 1290105973L;		
	} // end class
}  // end namespace
