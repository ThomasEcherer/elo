...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_findNextWorkflows : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.findNextWorkflows(ciValue, searchIdValue, indexValue, maxResultsValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal int maxResultsValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 1653142322L;		
	} // end class
}  // end namespace
