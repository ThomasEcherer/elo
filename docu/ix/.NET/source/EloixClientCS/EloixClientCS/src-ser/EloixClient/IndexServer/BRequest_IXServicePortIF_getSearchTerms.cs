...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_getSearchTerms : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.getSearchTerms(ciValue, findInfoValue, termTypeValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal int termTypeValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 349631039L;		
	} // end class
}  // end namespace
