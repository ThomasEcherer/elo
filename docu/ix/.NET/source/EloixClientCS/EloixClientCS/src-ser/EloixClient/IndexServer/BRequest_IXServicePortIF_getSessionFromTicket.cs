...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_getSessionFromTicket : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.getSessionFromTicket(ciValue, optionsValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal int optionsValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 147146740L;		
	} // end class
}  // end namespace
