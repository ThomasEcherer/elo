...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_getWebDAVPathFromObjID2 : BMethodRequest, BSerializable
	{
		...
		internal EloixClient.IndexServer.GetWebDAVPathOptions optionsValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 1018852852L;		
	} // end class
}  // end namespace
