...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_importWorkFlow2 : BMethodRequest, BSerializable
	{
		...
		internal byte[] fileDataValue;

		internal EloixClient.IndexServer.WorkflowImportOptions importOptionsValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 1996780008L;		
	} // end class
}  // end namespace
