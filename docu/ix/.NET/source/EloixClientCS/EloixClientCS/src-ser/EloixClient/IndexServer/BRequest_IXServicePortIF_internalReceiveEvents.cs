...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_internalReceiveEvents : BMethodRequest, BSerializable
	{
		...
		internal long timeoutMillisValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 1518401879L;		
	} // end class
}  // end namespace
