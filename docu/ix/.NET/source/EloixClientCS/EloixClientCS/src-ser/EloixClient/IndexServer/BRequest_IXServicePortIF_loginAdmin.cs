...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_loginAdmin : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.loginAdmin(ciValue, userNameValue, userPwdValue, clientComputerValue, reportAsUserValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal String reportAsUserValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 139618532L;		
	} // end class
}  // end namespace
