...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_queryJobProtocol : BMethodRequest, BSerializable
	{
		...
		internal EloixClient.IndexServer.QueryJobProtocolInfo queryJobProtocolInfoValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 1653875517L;		
	} // end class
}  // end namespace
