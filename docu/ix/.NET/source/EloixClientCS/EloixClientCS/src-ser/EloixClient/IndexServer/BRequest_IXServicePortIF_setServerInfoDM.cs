...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_setServerInfoDM : BMethodRequest, BSerializable
	{
		...
		internal EloixClient.IndexServer.ServerInfoDM serverInfoValue;

		#endregion
		
		
		public static readonly long serialVersionUID = 347556966L;		
	} // end class
}  // end namespace
