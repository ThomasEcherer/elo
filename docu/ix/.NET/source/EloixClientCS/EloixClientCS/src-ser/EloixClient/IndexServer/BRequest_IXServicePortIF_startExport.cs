...
namespace EloixClient.IndexServer
{
	...
	public sealed class BRequest_IXServicePortIF_startExport : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.startExport(ciValue, topLevelIDsValue, optionsValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal String[] topLevelIDsValue;
		...
		public static readonly long serialVersionUID = 1213820864L;		
	} // end class
}  // end namespace
