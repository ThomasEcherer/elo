...
namespace EloixClient.IndexServer
{
	...
	public class BSerializer_110863678 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_110863678();
		
		public BSerializer_110863678()
			: base(110863678) {}
		
		public BSerializer_110863678(int typeId)
			: base(typeId) {}
