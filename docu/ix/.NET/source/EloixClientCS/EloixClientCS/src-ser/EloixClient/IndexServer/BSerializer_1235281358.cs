...
namespace EloixClient.IndexServer
{
	...
	public class BSerializer_1235281358 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_1235281358();
		
		public BSerializer_1235281358()
			: base(1235281358) {}
		
		public BSerializer_1235281358(int typeId)
			: base(typeId) {}
		
		
		public override void write(Object obj1, BOutput bout1, long version)
		{
			BRequest_IXServerEvents_onBeforeCheckinUsers obj = (BRequest_IXServerEvents_onBeforeCheckinUsers)obj1;			
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			BRequest_IXServerEvents_onBeforeCheckinUsers obj = (BRequest_IXServerEvents_onBeforeCheckinUsers)(obj1 != null ? obj1 : bin.onObjectCreated(new BRequest_IXServerEvents_onBeforeCheckinUsers()));
