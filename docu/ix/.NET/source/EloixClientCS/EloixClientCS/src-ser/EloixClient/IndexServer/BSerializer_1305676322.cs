...
namespace EloixClient.IndexServer
{
	...
	public class BSerializer_1305676322 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_1305676322();
		
		public BSerializer_1305676322()
			: base(1305676322) {}
		
		public BSerializer_1305676322(int typeId)
			: base(typeId) {}
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			BRequest_IXServicePortIF_takeWorkFlowNode obj = (BRequest_IXServicePortIF_takeWorkFlowNode)(obj1 != null ? obj1 : bin.onObjectCreated(new BRequest_IXServicePortIF_takeWorkFlowNode()));
			
			BBufferBin bbuf = bin.bbuf;
			// checkpoint byps.gen.cs.PrintContext:449
			obj.nFlagsValue = bbuf.getInt();
			// checkpoint byps.gen.cs.PrintContext:449
			obj.nFlowIdValue = bbuf.getInt();
			// checkpoint byps.gen.cs.PrintContext:449
			obj.nNodeIdValue = bbuf.getInt();
			// checkpoint byps.gen.cs.PrintContext:449
			obj.sUserIdValue = bbuf.getString();
			// checkpoint byps.gen.cs.PrintContext:449
