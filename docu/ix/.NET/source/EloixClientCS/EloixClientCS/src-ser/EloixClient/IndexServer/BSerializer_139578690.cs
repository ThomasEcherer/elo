...
namespace EloixClient.IndexServer
{
	...
	public class BSerializer_139578690 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_139578690();
		
		public BSerializer_139578690()
			: base(139578690) {}
		
		public BSerializer_139578690(int typeId)
			: base(typeId) {}
