...
namespace EloixClient.IndexServer
{
	...
	public class BSerializer_1702478812 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_1702478812();
		
		public BSerializer_1702478812()
			: base(1702478812) {}
		
		public BSerializer_1702478812(int typeId)
			: base(typeId) {}
		
		
		public override void write(Object obj1, BOutput bout1, long version)
		{
			BRequest_IXServerEvents_onBeforeCheckinSord obj = (BRequest_IXServerEvents_onBeforeCheckinSord)obj1;			
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			BRequest_IXServerEvents_onBeforeCheckinSord obj = (BRequest_IXServerEvents_onBeforeCheckinSord)(obj1 != null ? obj1 : bin.onObjectCreated(new BRequest_IXServerEvents_onBeforeCheckinSord()));
