...
namespace EloixClient.IndexServer
{
	...
	public class BSerializer_1920958924 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_1920958924();
		
		public BSerializer_1920958924()
			: base(1920958924) {}
		
		public BSerializer_1920958924(int typeId)
			: base(typeId) {}
		
		
		public override void write(Object obj1, BOutput bout1, long version)
		{
			BRequest_IXServerEvents_onAfterCheckinDocEnd obj = (BRequest_IXServerEvents_onAfterCheckinDocEnd)obj1;			
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			BRequest_IXServerEvents_onAfterCheckinDocEnd obj = (BRequest_IXServerEvents_onAfterCheckinDocEnd)(obj1 != null ? obj1 : bin.onObjectCreated(new BRequest_IXServerEvents_onAfterCheckinDocEnd()));
