...
namespace EloixClient.IndexServer
{
	...
	public class BSerializer_227337860 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_227337860();
		
		public BSerializer_227337860()
			: base(227337860) {}
		
		public BSerializer_227337860(int typeId)
			: base(typeId) {}
		
		
		public override void write(Object obj1, BOutput bout1, long version)
		{
			BRequest_IXServerEvents_onReadSord obj = (BRequest_IXServerEvents_onReadSord)obj1;			
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			BRequest_IXServerEvents_onReadSord obj = (BRequest_IXServerEvents_onReadSord)(obj1 != null ? obj1 : bin.onObjectCreated(new BRequest_IXServerEvents_onReadSord()));
