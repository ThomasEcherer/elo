...
namespace EloixClient.IndexServer
{
	...
	public class BSerializer_40991853 : BSerializer {
		
		public readonly static BSerializer instance = new BSerializer_40991853();
		
		public BSerializer_40991853()
			: base(40991853) {}
		
		public BSerializer_40991853(int typeId)
			: base(typeId) {}
		
		
		public override void write(Object obj1, BOutput bout1, long version)
		{
			BRequest_IXServerEvents_onAfterDeleteMap obj = (BRequest_IXServerEvents_onAfterDeleteMap)obj1;			
		...
		public override Object read(Object obj1, BInput bin1, long version)
		{
			...
			BRequest_IXServerEvents_onAfterDeleteMap obj = (BRequest_IXServerEvents_onAfterDeleteMap)(obj1 != null ? obj1 : bin.onObjectCreated(new BRequest_IXServerEvents_onAfterDeleteMap()));
