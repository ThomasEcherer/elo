...
namespace EloixClient.IndexServer
{
	...
	public class BSerializer_914434915 : EloixClient.IndexServer.BSerializer_175726414 {
		
		public readonly static new BSerializer instance = new BSerializer_914434915();
		
		public BSerializer_914434915()
			: base(914434915) {}
		
		public BSerializer_914434915(int typeId)
			: base(typeId) {}
