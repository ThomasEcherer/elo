...
namespace EloixClient.IndexServer
{
	...
	/// </remarks>
	public class KeywordZ : EloixClient.IndexServer.ValueClass, BSerializable
	{
		...
		public KeywordZ(KeywordZ rhs) : base(rhs)
		{
		...
		public static readonly new long serialVersionUID = 450335637L;		
	} // end class
}  // end namespace
