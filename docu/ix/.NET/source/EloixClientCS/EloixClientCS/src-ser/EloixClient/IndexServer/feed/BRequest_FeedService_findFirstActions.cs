...
namespace EloixClient.IndexServer.feed
{
	...
	public sealed class BRequest_FeedService_findFirstActions : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.findFirstActions(ciValue, findInfoValue, maxValue, actionZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		internal EloixClient.IndexServer.feed.FindActionsInfo findInfoValue;
		...
		public static readonly long serialVersionUID = 334710983L;		
	} // end class
}  // end namespace
