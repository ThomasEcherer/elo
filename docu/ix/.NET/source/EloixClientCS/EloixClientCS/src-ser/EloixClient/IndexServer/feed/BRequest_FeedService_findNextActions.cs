...
namespace EloixClient.IndexServer.feed
{
	...
	public sealed class BRequest_FeedService_findNextActions : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.findNextActions(ciValue, searchIdValue, idxValue, maxValue, actionZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 933597872L;		
	} // end class
}  // end namespace
