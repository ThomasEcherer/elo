...
namespace EloixClient.IndexServer.feed
{
	...
	public sealed class BRequest_FeedService_findNextHashTagRelation : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.findNextHashTagRelation(ciValue, searchIdValue, idxValue, maxValue, hashTagZValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 1204755579L;		
	} // end class
}  // end namespace
