...
namespace EloixClient.IndexServer.feed
{
	...
	public sealed class BRequest_FeedService_unregisterNotify : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.unregisterNotify(ciValue, feedGuidValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 285270298L;		
	} // end class
}  // end namespace
