...
namespace EloixClient.IndexServer.feed
{
	...
	public class BSerializer_556531185 : EloixClient.IndexServer.BSerializer_175726414 {
		
		public readonly static new BSerializer instance = new BSerializer_556531185();
		
		public BSerializer_556531185()
			: base(556531185) {}
		
		public BSerializer_556531185(int typeId)
			: base(typeId) {}
