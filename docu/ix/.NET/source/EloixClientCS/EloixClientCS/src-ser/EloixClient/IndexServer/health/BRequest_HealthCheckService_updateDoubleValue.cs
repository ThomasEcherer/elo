...
namespace EloixClient.IndexServer.health
{
	...
	public sealed class BRequest_HealthCheckService_updateDoubleValue : BMethodRequest, BSerializable
	{
		...
		public override void execute(BRemote __byps__remote, BAsyncResultIF<Object> __byps__asyncResult) {
			...
			try {
				...
				__byps__remoteT.updateDoubleValue(ciValue, nameValue, doubleValueValue, BAsyncResultHelper.ToDelegate(__byps__outerResult));
			} catch (Exception e) {
		...
		public static readonly long serialVersionUID = 677413784L;		
	} // end class
}  // end namespace
