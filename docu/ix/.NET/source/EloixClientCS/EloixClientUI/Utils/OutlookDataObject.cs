...
namespace EloixClientUI.Utils
{
    ...
    public class OutlookDataObject: System.Windows.Forms.IDataObject
    {
        ...
        private class NativeMethods
        {
            ...
            {
              public uint pFiles;                       // offset of file list
              public POINTL pt;                         // drop point (client coords)
              public ushort fNC;                        // is it on NonClient area
                                                        // and pt is in screen coords
              public ushort fWide;                      // WIDE character switch
            }
        }
        ...
        /// </summary>
        public System.Runtime.InteropServices.ComTypes.IDataObject comUnderlyingDataObject;
